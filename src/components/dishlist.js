        ...
        <div className='container-fluit'>
            <nav className="navbar navbar-expand-sm bg-dark navbar-dark">
                ...
                <a className="navbar-brand" href="#">
                    <img src={`http://localhost:8000/image/avt.jpg`} alt="logo" style={{ width: '40px' }} />
                </a>
                {/* Links */}
            ...
            <div className='container'>
                ...
                <div>
                    <div><h2 className="text-center text-danger">Có {ricelist.length} món cơm: </h2></div>
                    <div className="row">
                        {
                            ricelist
                                .map((dishes, index) =>
                    ...
                    <div><h2 className="text-center text-danger">Có {breadlist.length} món bánh mì: </h2></div>
                    <div className="row">
                        {
                            breadlist
                                .map((dishes, index) =>
                                    <div className='col-6'>
                                        <div className="row">
                                            <div class="col-3"><img src={`http://localhost:8000/image/${dishes.image}`} className="img-thumbnail" alt="" /></div>
                                            <div class="col-9 text-dark">
                                                <br />
                                                <div class="row">
                                                    <div class="col-8"><h5>{dishes.name}</h5></div>
                                                    <div class="col-4  text-right">{dishes.price} .vnđ</div>
                                                </div>
                                                <p>{dishes.des}</p>
                                            </div>
                                        </div>
                    ...
                    <div><h2 className="text-center text-danger">Có {noodleslist.length} món bún(phở): </h2></div>
                    <div className="row">
                        {
                            noodleslist
                                .map((dishes, index) =>
                                    <div className='col-4'>
                                        <div className="row">
                                            ...
                                            <br />
                                            <div class="row">
                                                <div class="col-6"><h5>{dishes.name}</h5></div>
                                                <div class="col-6  text-right">{dishes.price} .vnđ</div>
                                            </div>
                                            <p>{dishes.des}</p>
